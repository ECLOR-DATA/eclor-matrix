...
- **Current version:** 1.11.0.0 — see [CHANGELOG.md](CHANGELOG.md)
...
- Tests in [test/](test/) — Jest + jsdom + ts-jest (20 suites, count via `npm test`); shared harness [test/_harness.ts](test/_harness.ts) builds matrix DataViews
