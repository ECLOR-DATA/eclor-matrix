...
> Doc de référence du pipeline multi-agents pour visuels Power BI custom.
> Compagnon du playbook (`~/.claude/powerbi-visuals-playbook.md` / `<repo>/docs/CLAUDE_PLAYBOOK.md`).
> Créé 2026-07-25 après la certification d'eclor-waterfall (première exécution complète du pipeline).
