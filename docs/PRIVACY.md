...
`Eclor Matrix` (ci-après "le Visuel") est édité par **[ECLOR]** (ci-après "l'Éditeur").
...
`Eclor Matrix` (the "Visual") is published by **[ECLOR]** (the "Publisher").
